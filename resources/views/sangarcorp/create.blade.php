                                ...
                                <fieldset> 
                                    ...
                                    <div> 
                                        ...
                                        <div class="form-group"> 
                                            ...
                                            <input id="sos_phy_street" name="sos_phy_street" type="text" placeholder="placeholder" class="form-control input-md"> 
                                        </div>                                         
                                        <div class="form-group"> 
                                            <label class="control-label text-left" for="textinput">Street 2</label>                                             
                                            <input id="sos_phy_street_two" name="sos_phy_street_two" type="text" placeholder="placeholder" class="form-control input-md"> 
                                        </div>                                         
                                        <div class="form-group"> 
                                            <label class="control-label text-left" for="textinput">City</label>                                             
                                            <input id="sos_phy_city" type="text" placeholder="placeholder" class="form-control input-md" name="sos_phy_city"> 
                                        </div>                                         
                                        <div class="form-group"> 
                            ...
                            <div class="col-md-3"> 
                                <fieldset> 
                                    ...
                                    <div> 
                                        <div class="form-group"> 
                                            <label class="control-label" for="formInput740">Office Type</label>                                             
                                            <select id="sos_mail_type" class="form-control" name="sos_mail_type"> 
                                                <option value="sangar">Sangar</option>                                                 
                                                <option value="client">Client Site</option>                                                 
                                                <option value="rental">Office Rental</option>                                                 
                                            </select>                                             
                                        ...
                                        <div class="form-group"> 
                                            <label class="control-label text-left" for="textinput">Street</label>                                             
                                            <input id="sos_mail_street" type="text" placeholder="placeholder" class="form-control input-md" name="sos_mail_street"> 
                                        </div>                                         
                                        <div class="form-group"> 
                                            <label class="control-label text-left" for="textinput">Street 2</label>                                             
                                            <input id="sos_mail_street_two" type="text" placeholder="placeholder" class="form-control input-md" name="sos_mail_street_two"> 
                                        </div>                                         
                                        <div class="form-group"> 
                                            <label class="control-label text-left" for="textinput">City</label>                                             
                                            <input id="sos_mail_city" type="text" placeholder="placeholder" class="form-control input-md" name="sos_mail_city"> 
                                        </div>                                         
                                        <div class="form-group"> 
                                            <label class="control-label" for="formInput740">State</label>                                             
                                            <select id="sos_mail_state" class="form-control" name="sos_mail_state"> 
                                                <option>1</option>                                                 
                                                <option>2</option>                                                 
                                                <option>3</option>                                                 
                                            </select>                                             
                                        ...
                                        <div class="form-group"> 
                                            <label class="control-label text-left" for="textinput">Zipcode</label>                                             
                                            <input id="sos_mail_zip" type="text" placeholder="placeholder" class="form-control input-md" name="sos_mail_zip"> 
                                        </div>                                         
                                    </div>                                     
                                </fieldset>                                 
                            </div>                             
                            ...
                            <div class="col-md-3"> 
                                <fieldset> 
                                    ...
                                    <div> 
                                        ...
                                        <div class="form-group"> 
                                            <label class="control-label" for="formInput1185">Notes</label>                                             
                                            <textarea class="form-control" id="sec_notes" rows="8" name="sos_notes"></textarea>                                             
                                        </div>                                         
                                    </div>                                     
                                </fieldset>                                 
                            </div>                             
                            <div class="col-md-3"> 
                                <fieldset> 
                                    ...
                                    <div> 
                                        <div class="form-group"> 
                                            <label class="control-label" for="formInput740">Office Type</label>                                             
                                            <select id="sec_office_type" class="form-control" name="sec_office_type" value="sangar"> 
                                                <option value="sangar">Sangar</option>                                                 
                                                <option value="client">Client Site</option>                                                 
                                                <option value="rental">Office Rental</option>                                                 
                                            </select>                                             
                            ...
                            <div class="col-md-3"> 
                                <fieldset> 
                                    ...
                                    <div> 
                                        <div class="form-group"> 
                                            <label class="control-label" for="formInput740">Office Type</label>                                             
                                            <select id="sec_mail_type" class="form-control" name="sec_mail_type"> 
                                                <option value="sangar">Sangar</option>                                                 
                                                <option value="client">Client Site</option>                                                 
                                                <option value="rental">Office Rental</option>                                                 
                                            </select>                                             
