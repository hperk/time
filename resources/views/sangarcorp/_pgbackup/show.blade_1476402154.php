                                        ...
                                        <fieldset>
                                            ...
                                            <div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input id="sos_date_due" type="date" placeholder="placeholder" class="form-control input-md" readonly="readonly" name="sos_date_due">
                                                </div>
                                                <div class="form-group">
                                        ...
                                        <fieldset>
                                            ...
                                            <div>
                                                <div class="form-group">
                                                    ...
                                                    <select id="phy_office_type" class="form-control" name="phy_office_type">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input id="phy_street" name="phy_street" type="text" placeholder="placeholder" class="form-control input-md">
                                                </div>
                                                <div class="form-group">
                                                    <label class="control-label text-left" for="textinput">Street 2</label>
                                                    <input id="phy_street_two" name="phy_street_two" type="text" placeholder="placeholder" class="form-control input-md">
                                                </div>
                                                <div class="form-group">
                                                    <label class="control-label text-left" for="textinput">City</label>
                                                    <input id="phy_city" type="text" placeholder="placeholder" class="form-control input-md" name="phy_city">
                                                </div>
                                                <div class="form-group">
                                                    <label class="control-label" for="formInput740">State</label>
                                                    <select id="phy_state" class="form-control" name="phy_state">
                                                        <option>1</option>
                                                        <option>2</option>
                                                        <option>3</option>
                                                    </select>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input id="phy_zip" type="text" placeholder="placeholder" class="form-control input-md" name="phy_zip">
                                                </div>
                                            </div>
                                        </fieldset>
                                    </div>
                                    ...
                                    <div class="col-md-3">
                                        <fieldset>
                                            ...
                                            <div>
                                                ...
                                                <div class="form-group">
                                                    <label class="control-label text-left" for="textinput">Next File</label>
                                                    <input id="sec_date_due" name="sec_date_due" type="date" placeholder="placeholder" class="form-control input-md" readonly="readonly">
                                                </div>
                                            </div>
                                        </fieldset>
                                    </div>
