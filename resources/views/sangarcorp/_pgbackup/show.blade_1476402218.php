...
<html lang="en"> 
    ...
    <body> 
                ...
                <fieldset> 
                    ...
                    <div class="col-md-4"> 
                        ...
                        <div class="form-group"> 
                            ...
                            <input id="legal_name" name="legal_name" type="text" placeholder="placeholder" class="form-control input-md" value="{{$sangarcorp->"> 
                        </div>                         
                        <div class="form-group"> 
                            <label class="control-label" for="formInput740">Incorporation State</label>                             
                            <select id="incorp_state" class="form-control" name="incorp_state" value="{{$sangarcorp->"> 
                                <option>1</option>                                 
                                <option>2</option>                                 
                                <option>3</option>                                 
                            </select>                             
                    ...
                    <div class="col-md-4"> 
                        <div class="form-group"> 
                            ...
                            <input id="textinput" name="fein" type="text" placeholder="placeholder" class="form-control input-md" style="fein" value="{{$sangarcorp->"> 
                        </div>                         
                        <div class="form-group"> 
                            <b>Security Lic #</b> 
                            <br> 
                            <input id="sec_lic" name="sec_lic" type="text" placeholder="placeholder" class="form-control input-md" value="{{$sangarcorp->"> 
                        </div>                         
                        <div class="form-group"> 
                            <b>State Biz / Tax ID</b> 
                            <br> 
                            <input id="state_tax_id" name="state_tax_id" type="text" placeholder="placeholder" class="form-control input-md" value="{{$sangarcorp->"> 
                        </div>                         
                    </div>                     
                    <div class="col-md-4"> 
                        <div class="form-group" style="outline-style: solid"> 
                            <label class="control-label" for="formInput740">SUBSIDIARY OF:</label>                             
                            <select id="sub_of" class="form-control" name="sub_of" value="{{$sangarcorp->"> 
                                <option>1</option>                                 
                                <option>2</option>                                 
                                <option>3</option>                                 
                            </select>                             
                        ...
                        <div class="form-group"> 
                            <b>Oasis ID</b> 
                            <br> 
                            <input id="oasis_id" name="oasis_id" type="text" placeholder="placeholder" class="form-control input-md" value="{{$sangarcorp->"> 
                        </div>                         
                        <div class="form-group"> 
                            <b>QB Location Name</b> 
                            <br> 
                            <input id="qb_loc" name="qb_loc" type="text" placeholder="placeholder" class="form-control input-md" value="{{$sangarcorp->"> 
                        </div>                         
                    </div>                     
                </fieldset>                 
            </div>             
                                ...
                                <fieldset> 
                                    ...
                                    <div> 
                                        ...
                                        <div class="form-group"> 
                                            ...
                                            <select id="sos_renew_interval" class="form-control" name="sos_renew_interval" value="{{$sangarcorp->"> 
                                        ...
                                        <div class="form-group"> 
                                            ...
                                            <input id="sos_date_due" type="date" placeholder="placeholder" class="form-control input-md" readonly="readonly" name="sos_date_due" value="{{$sangarcorp->"> 
                                        </div>                                         
                                        <div class="form-group"> 
                                ...
                                <fieldset> 
                                    ...
                                    <div> 
                                        <div class="form-group"> 
                                            ...
                                            <select id="phy_office_type" class="form-control" name="phy_office_type" value="{{$sangarcorp->"> 
                                        ...
                                        <div class="form-group"> 
                                            ...
                                            <input id="phy_street" name="phy_street" type="text" placeholder="placeholder" class="form-control input-md" value="{{$sangarcorp->"> 
                                        </div>                                         
                                        <div class="form-group"> 
                                            <label class="control-label text-left" for="textinput">Street 2</label>                                             
                                            <input id="phy_street_two" name="phy_street_two" type="text" placeholder="placeholder" class="form-control input-md" value="{{$sangarcorp->"> 
                                        </div>                                         
                                        <div class="form-group"> 
                                            <label class="control-label text-left" for="textinput">City</label>                                             
                                            <input id="phy_city" type="text" placeholder="placeholder" class="form-control input-md" name="phy_city" value="{{$sangarcorp->"> 
                                        </div>                                         
                                        <div class="form-group"> 
                                            <label class="control-label" for="formInput740">State</label>                                             
                                            <select id="phy_state" class="form-control" name="phy_state" value="{{$sangarcorp->"> 
                                                <option>1</option>                                                 
                                                <option>2</option>                                                 
                                                <option>3</option>                                                 
                                            </select>                                             
                                        ...
                                        <div class="form-group"> 
                                            ...
                                            <input id="phy_zip" type="text" placeholder="placeholder" class="form-control input-md" name="phy_zip" value="{{$sangarcorp->"> 
                                        </div>                                         
                                    </div>                                     
                                </fieldset>                                 
                            </div>                             
                            <div class="col-md-3"> 
                                <fieldset> 
                                    ...
                                    <div> 
                                        <div class="form-group"> 
                                            <label class="control-label" for="formInput740">Office Type</label>                                             
                                            <select id="mail_office_type" class="form-control" name="mail_office_type" value="{{$sangarcorp->"> 
                                                <option value="sangar">Sangar</option>                                                 
                                                <option value="client">Client Site</option>                                                 
                                                <option value="rental">Office Rental</option>                                                 
                                            </select>                                             
                                        ...
                                        <div class="form-group"> 
                                            <label class="control-label text-left" for="textinput">Street</label>                                             
                                            <input id="mail_street" type="text" placeholder="placeholder" class="form-control input-md" name="mail_street" value="{{$sangarcorp->"> 
                                        </div>                                         
                                        <div class="form-group"> 
                                            <label class="control-label text-left" for="textinput">Street 2</label>                                             
                                            <input id="mail_street_two" type="text" placeholder="placeholder" class="form-control input-md" name="mail_street_two" value="{{$sangarcorp->"> 
                                        </div>                                         
                                        <div class="form-group"> 
                                            <label class="control-label text-left" for="textinput">City</label>                                             
                                            <input id="mail_city" type="text" placeholder="placeholder" class="form-control input-md" name="mail_city" value="{{$sangarcorp->"> 
                                        </div>                                         
                                        <div class="form-group"> 
                                            <label class="control-label" for="formInput740">State</label>                                             
                                            <select id="mail_state" class="form-control" name="mail_state" value="{{$sangarcorp->"> 
                                                <option>1</option>                                                 
                                                <option>2</option>                                                 
                                                <option>3</option>                                                 
                                            </select>                                             
                                        ...
                                        <div class="form-group"> 
                                            <label class="control-label text-left" for="textinput">Zipcode</label>                                             
                                            <input id="mail_zip" type="text" placeholder="placeholder" class="form-control input-md" name="mail_zip" value="{{$sangarcorp->"> 
                                        </div>                                         
                                    </div>                                     
                                </fieldset>                                 
                            </div>                             
                            ...
                            <div class="col-md-3"> 
                                <fieldset> 
                                    ...
                                    <div> 
                                        ...
                                        <div class="form-group"> 
                                            <label class="control-label text-left" for="textinput">Next File</label>                                             
                                            <input id="sec_date_due" name="sec_date_due" type="date" placeholder="placeholder" class="form-control input-md" readonly="readonly" value="&quot;{{$sangarcorp->sec_date_due}}&quot;"> 
                                        </div>                                         
                                    </div>                                     
                                </fieldset>                                 
                            </div>                             
        ...
        <script>$('input, select').attr('value', string());</script>         
        <script>
            $('#edit').click(function(){
